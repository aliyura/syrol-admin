...
<head>
	...
	<title>Syrol Technologies | Admin Panel</title>
...
<body>
			...
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="index.php">
			  		<img alt="DbCompany" src="images/dbcompany.png">
			  	</a>
						...
						<div class="module-foot">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-warning pull-right" name="submit">Login</button>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2020 Syrol Technologies </b> |  All rights reserved.
		</div>
	</div>
